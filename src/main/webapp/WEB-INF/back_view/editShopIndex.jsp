	...
	<script type="text/javascript">
		...
		function addNavIcon() {
			...
			$('#addNavIcon').fileinput({
    	        ...
    	        uploadExtraData : function(previewId, index){
    	        	//动态获取参数值
    	        	var data={"info":$('#info').val(),"areaID":1};
    	        	return data;
    	        },
    	    });
			//这是提交完成后的回调函数
	...
	<section>
		<div style=" background-color:#19A97B; width:40%; margin:0 auto">
			...
			<table style="margin:0px auto;width: 100%;margin-bottom: 10px;">
				...
				<tr align="center">
					<td><img onclick="updateSmallIcon('shop_small_icon_1.png')" src="/jlmytk/A_INDEX/SMALLICON/shop_small_icon_1.png" width="60%"/></td>
					<td><img onclick="updateSmallIcon('shop_small_icon_2.png')" src="/jlmytk/A_INDEX/SMALLICON/shop_small_icon_2.png" width="60%"/></td>
					<td><img onclick="updateSmallIcon('shop_small_icon_3.png')" src="/jlmytk/A_INDEX/SMALLICON/shop_small_icon_3.png" width="60%"/></td>
					<td><img onclick="updateSmallIcon('shop_small_icon_4.png')" src="/jlmytk/A_INDEX/SMALLICON/shop_small_icon_4.png" width="60%"/></td>
					<td><img onclick="updateSmallIcon('shop_small_icon_5.png')" src="/jlmytk/A_INDEX/SMALLICON/shop_small_icon_5.png" width="60%"/></td>
				</tr>
				<tr>
					<td>美甲</td>
					<td>美睫</td>
