...
<head>
	...
	<script type="text/javascript">
		...
		function goodParse(good) {
			...
			goodInfo+='<td><a href="back.do?toName=addGood.jsp&goodID='+good.id+'" class="inner_btn">编辑</a><a href="javascript:void(0);" class="inner_btn" onclick="deleteGood('+good.id+')">删除</a></td></tr>';
			return goodInfo;
		}
