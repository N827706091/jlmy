...
<div class="row">
	<div class="member_top member_top_1">
		<div class="member_top_bg"><img  src="images/front_images/user-bg.png"></div>
		<div class="member_m_pic member_m_pic_1"><img class="img-circle" src="images/touxiang.jpg"></div>
		<div class="member_m_z member_m_z_1"><div class="member_m_x"></div></div>
		<div class="member_m_r">账户管理、收货地址&gt;</div>
	</div>
	<div class="member_mp_img" data-toggle="modal" data-target="#myModalmin" data-title="我的名片" data-tpl="mp"><img src="images/front_images/member_mp_img.png"></div>
		<div class="list-group mb10">
			<a href="My indent.html" class="list-group-item tip">
				<div class="list_group_img"><img src="images/front_images/member_img_order.png"></div>我的订单
				<span class="gary pull-right">查看全部</span>
			</a>
			<div class="list-group-item p0 clearfix">
				<div class="col-xs-3 p0"><a class="order_tab_link" href="My indent dfk.html"><em class="order_img"><img src="images/front_images/order_bg_3.png"></em>待付款</a></div>
				<div class="col-xs-3 p0"><a class="order_tab_link" href="My indent dfh.html"><em class="order_img"><img src="images/front_images/order_bg_2.png"></em>待发货</a></div>
				<div class="col-xs-3 p0"><a class="order_tab_link" href="My indent dsh.html"><em class="order_img"><img src="images/front_images/order_bg_1.png"></em>待收货</a></div>
				<div class="col-xs-3 p0"><a class="order_tab_link" href="My indent ywc.html"><em class="order_img"><img src="images/front_images/order_bg.png"></em>已完成</a></div>
			</div>
		</div>
		...
		<div class="list-group mb10">
			<a href="/p/help" class="list-group-item tip"><div class="list_group_img"><img src="images/order_bg_10.png"></div>常见问题</a>
			<a href="/p/feedbacks" class="list-group-item tip"><div class="list_group_img"><img src="images/order_bg_9.png"></div>意见反馈</a>
		</div>
	</div>
</div>
      	...
      	<form class="form-horizontal" role="form" data-method="formAjax">
			 ...
			 <div style="overflow:hidden;width: 100%;padding-top: 20px;">
				<div style="">
					 ...
					 <div class="member_mp_t_m">用户名</div>
...
<footer class="footer">
	<div class="foot-con">
		<div class="foot-con_2">
			...
			<a href="" class="active"><i class="navIcon member"></i><span class="text">我的</span></a>
		</div>
	</div>
</footer>
</div>
